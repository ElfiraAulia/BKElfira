...
// Generate No RM untuk pasien baru
$tahunBulan = date('Ym');
...
$no_rm_generate = sprintf('%s-%d', $tahunBulan, $urutan);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add'])) {
        ...
        $password = md5($_POST['password']); // Menggunakan MD5 untuk hashing
        $no_rm = $no_rm_generate;
    ...
    if (isset($_POST['edit'])) {
        ...
        $result = $conn->query("UPDATE pasien SET nama='$nama', alamat='$alamat', no_ktp='$no_ktp', no_hp='$no_hp', username='$username' WHERE id='$id'");
        if ($result) {
                                ...
                                <form method="POST">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label>No RM</label>
                                                <input type="text" name="no_rm" class="form-control readonly-input" value="<?= $row['no_rm'] ?>" readonly>
                                            </div>
                                            <div class="mb-3">
